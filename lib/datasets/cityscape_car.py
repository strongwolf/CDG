...
class cityscape_car(imdb):
    def __init__(self, image_set, devkit_path=None):
        ...
        self._devkit_path = cfg_d.CITYSCAPE_CAR
    ...
    def _load_pascal_annotation(self, index):
        ...
        format.
        """
        filename = os.path.join(self._data_path, 'annos', index + '.xml')
        ...
        norms = np.zeros(num_objs, dtype=np.float32)
        ...
        for ix, obj in enumerate(objs):
            ...
            try:
                ...
                continue
            normc = obj.find('norm')
            norm = float(normc.text) if normc != None else 0
            norms[count] = norm
    ...
    def _do_python_eval(self, output_dir='output'):
        ...
        for element in thresh:
            ...
            print('--------------------------------------------------------------')
        # np.save("sim10k_ours.npy", saved_val)
        return aps
    ...
    def evaluate_detections(self, all_boxes, output_dir):
        ...
        ops = self._do_python_eval(output_dir)
