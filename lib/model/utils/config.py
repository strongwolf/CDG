...
__C.VGG_PATH = 'data/pretrained_model/vgg16-caffe.pth'
__C.RESNET_50_PATH = 'data/pretrained_model/resnet50-caffe.pth'
__C.RESNET_101_PATH = 'data/pretrained_model/resnet101-caffe.pth'
__C.MIN_RES = 0.18
__C.MAX_RES = 0.63
__C.THETA = 0.9
import pdb
